...
public class NeuralNetwork implements NetworkInterface {
    ...
    public void measureNetworkError(ArrayList<InputTargetPair> inputTargetPairs){
        networkError = 0;
        for(InputTargetPair inputTargetPair: inputTargetPairs) {
            if(inputTargetPair.getInputSize()==inNeuronCount && inputTargetPair.getTargetSize()==outNeuronCount) {
                ...
                for(int index=0; index<inputTargetPair.getTargetSize(); index++) {
    ...
    public void resetSynapses(int layerIndex){
            layers[layerIndex].resetSynapses();
    }
    public void resetSynapses(int layerIndex, int neuronIndex){
        layers[layerIndex].resetSynapses(neuronIndex);
    }
